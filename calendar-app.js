var Functions = /** @class */ (function () {
    ...
    Functions.prototype.setChoosePosition = function () {
    ...
    Functions.prototype.navArrow_Next = function () {
        ...
        ['click', 'touchend'].forEach(function (ev) {
            navArrowNext.addEventListener(ev, function () {
                ...
                _this.setChoosedDay(); // Trzeba wywołać, gdyż trzeba wyznaczyć pozycję wybranego dnia w kalendarzu.
